function [spout_calibration, command_x, command_y, command_z] = addPositionToCalibration_1D(spout_calibration, command_y)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%   vectors.
spout_calibration = add_y_to_xz_command_map(spout_calibration, command_y);
