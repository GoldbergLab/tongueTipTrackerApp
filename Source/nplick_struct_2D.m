function [nl_struct,raster_struct, result] = nplick_struct_2D(dirlist_root)
    ...
    for i=1:numel(dirlist)     
       ...
       nl_struct(i).np_pairs = sensor_on_off_times(working_buff(:,4));
       nl_struct(i).dispense = sensor_on_off_times(working_buff(:,5));
       nl_struct(i).laser_on = sensor_on_off_times(working_buff(:,6));
...
% raster_struct = 1;
       ...
       lick_struct = make_rw_struct_2D(nl_struct);
