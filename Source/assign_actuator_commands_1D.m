function t_stats = assign_actuator_commands_1D(t_stats,l_sp_struct, vid_index)
...
%             t_stats(i).actuator_command_x = l_sp_struct(vid_index(t_stats(i).trial_num)).actuator1_ML_command;
            t_stats(i).actuator_command_y = l_sp_struct(vid_index(t_stats(i).trial_num)).actuator1_AP_command;
        else
