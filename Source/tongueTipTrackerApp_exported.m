classdef tongueTipTrackerApp_exported < matlab.apps.AppBase
    ...
    properties (Access = public)
        ...
        TrackTongueTipsContextMenu      matlab.ui.container.ContextMenu
...
%                      viewSpoutTracking(sessionMaskRoot, sessionVideoRoot, sessionFPGARoot, time_aligned_trial, spout_calibration, cue_frame)
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.SingleframedebugMenu = uimenu(app.TrackTongueTipsContextMenu);
            ...
            % Assign app.TrackTongueTipsContextMenu
            app.TrackTongueTipsButton.ContextMenu = app.TrackTongueTipsContextMenu;
