function t_stats = mapSpoutCommandToPosition_1D(t_stats, spout_calibration)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
spout_calibration = addPositionToCalibration_1D(spout_calibration, all_command_y);

for lickNum = 1:length(t_stats)
    command_y = t_stats(lickNum).actuator_command_y;
    % Create fake x- and z-command vector
    [command_x, command_z] = spout_calibration.map_y_to_xz_command(command_y);
