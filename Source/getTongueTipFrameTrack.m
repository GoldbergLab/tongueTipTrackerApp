function [tip_coords, centroid_coords, volume] = getTongueTipFrameTrack(bot_mask, top_mask, params, illustrate)

% Check if user wants debug output
...
[tip_coords, centroid_coords, volume, top_area, bot_area, ...
    ...
    t_boundary] = tongueTipTracker(top_mask, bot_mask, params, [], [], illustrate);
