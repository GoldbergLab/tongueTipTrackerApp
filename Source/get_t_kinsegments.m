...
if length(x_plt) >= 3
    ...
    % Can't calculate radius of curvature with fewer than 3 trajectory
    % points
    rad_curv = [];
end

if length(speed) >= 4 && length(rad_curv) >= 3
    ...
    % Not enough trajectory points to calculating redir_pts
    redir_pts = [];
end
